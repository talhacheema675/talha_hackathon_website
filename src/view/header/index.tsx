    ...
    return(
        <nav className="flex flex-row lg:px-20 md:px-20 sm:px-2 px-2 pt-8 lg:gap-28 md:gap-28 sm:gap-4 gap-4 w-full bg-white fixed">
            ...
            <div className="flex lg:text-base md:text-base text-xs lg:font-bold md:font-bold w-max "> <NavigationMenu>
                    <NavigationMenuList >
                        <NavigationMenuItem className="lg:px-8 md:px-8 sm:px-1 px-1"><Link href="/female">Female</Link></NavigationMenuItem>
                        <NavigationMenuItem className="lg:px-8 md:px-8 sm:px-1 px-1"><Link href="/male">Male</Link></NavigationMenuItem>
                        <NavigationMenuItem className="lg:px-8 md:px-8 sm:px-1 px-1"><Link href="/kids">Kids</Link></NavigationMenuItem>
                        <NavigationMenuItem className="lg:px-8 md:px-8 sm:px-1 px-1"><Link href="/all_products">Product</Link> </NavigationMenuItem>
                    </NavigationMenuList>
                    </NavigationMenu>
            </div>
